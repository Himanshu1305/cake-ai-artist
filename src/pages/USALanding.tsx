        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden lg:flex gap-2 items-center">
              <Badge variant="outline" className="border-party-gold text-party-gold">🇺🇸 USA</Badge>
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-[280px] bg-background/95 backdrop-blur-md border-l border-party-pink/20">
                ...
                <div className="flex flex-col gap-2">
                  <Badge variant="outline" className="w-fit border-party-gold text-party-gold mb-4">🇺🇸 USA</Badge>
