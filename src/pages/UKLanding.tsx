...
const UKLanding = () => {
  ...
  const { isLoading, handlePayment, currentOrderId, checkPaymentStatus, isCheckingStatus } = useRazorpayPayment("GB");
  ...
  return (
    <div className="min-h-screen bg-gradient-celebration relative overflow-hidden">
      ...
      <FloatingEmojis />
      <UrgencyBanner onVisibilityChange={setIsBannerVisible} countryCode="UK" />
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden lg:flex gap-2 items-center">
              <Badge variant="outline" className="border-party-gold text-party-gold">🇬🇧 United Kingdom</Badge>
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-[280px] bg-background/95 backdrop-blur-md border-l border-party-pink/20">
                ...
                <div className="flex flex-col gap-2">
                  <Badge variant="outline" className="w-fit border-party-gold text-party-gold mb-4">🇬🇧 United Kingdom</Badge>
            ...
            >
              <div className="grid md:grid-cols-3 gap-4 text-center mb-4">
                <div>
                  ...
                  <p className="text-lg font-bold line-through text-muted-foreground">£96/year forever</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Your price:</p>
                  <p className="text-3xl font-bold text-gold">~£39 ONCE</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">You save:</p>
                  <p className="text-lg font-bold text-party-pink">£921+ over 10 years</p>
                </div>
              </div>
