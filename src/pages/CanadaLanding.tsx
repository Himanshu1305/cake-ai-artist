            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
              <Card className="text-center h-full">
                <CardContent className="pt-6">
                  ...
                  <p className="text-3xl font-bold text-party-pink mb-4">C$0</p>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
              <Card className="text-center border-party-pink shadow-lg relative h-full">
                ...
                <CardContent className="pt-8">
                  ...
                  <p className="text-3xl font-bold text-party-pink mb-4">C$67</p>
                  <ul className="text-sm text-muted-foreground space-y-2 mb-6">
              ...
              <Card className="text-center h-full">
                <CardContent className="pt-6">
                  ...
                  <Button 
                    variant="outline" 
                    className="w-full"
                    onClick={() => handlePayment('monthly_cad')}
                    disabled={isLoading !== null}
                  >
                    {isLoading === 'monthly_cad' ? <><Loader2 className="w-4 h-4 mr-2 animate-spin" />Processing...</> : 'Subscribe Monthly'}
                  </Button>
                </CardContent>
              </Card>
            </motion.div>
